...
export default function PasajerosScreen() {
  ...
  const handleContinuar = async () => {
    ...
    console.log('[PasajerosScreen] registrarPasajero input:', JSON.stringify(input, null, 2));
    ...
    <ScreenContainer>
      ...
      <View style={styles.card}>
        ...
        {error ? (
          ...
          <StateMessage title="Error al registrar pasajero" description={error.message} variant="error" />
